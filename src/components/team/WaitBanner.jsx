...
const WaitBanner = ({ active }) => {
    const { phase } = useGameStore()
    return (
        <div className="p-4 pt-3">
            {(phase == 'play' || phase == 'steal') && active &&
            ...
            {
                (phase == 'idle' || !active) && <div id="waitBanner" className="rounded-xl p-3 text-center border-2 border-gray-600 bg-gray-800 mt-4">
